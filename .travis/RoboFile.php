...
class RoboFile extends \Robo\Tasks
{
  ...
  public function jobCheckCodingStandards()
  {
    return $this->taskExecStack()
      ...
      ->exec('vendor/bin/phpcs --standard=Drupal web/modules/contrib')
      ->exec('vendor/bin/phpcs --standard=DrupalPractice web/modules/contrib')
      ->run();
  }
  /**
  ...
  protected function runUnitTests()
  {
    ...
    $tasks[] = $this->taskExecStack()
      ->dir('web')
      ->exec('../vendor/bin/phpunit -c core --debug --coverage-clover ../build/logs/clover.xml --verbose modules/contrib');
    return $tasks;
  }
  /**
   * Runs Behat tests.
