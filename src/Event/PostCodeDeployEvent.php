...
/**
 * An event type for representing a post-code-deploy operation.
 *
 * @package Drupal\cloudhooks\Event
 */
class PostCodeDeployEvent extends CloudhookEventBase implements CodeEventInterface {
  ...
  /**
   * Creates a post-code-deploy event.
   *
