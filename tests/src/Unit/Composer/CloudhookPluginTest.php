...
class CloudhookPluginTest extends TestCase {
   ...
   *
   * @covers \Drupal\cloudhooks\Composer\CloudhookPlugin::__construct
   */
  ...
  public function testGetInstaller() {
    ...
    $installer = $this->cloudhookPlugin->getInstaller($composer_mock, $io_mock, TRUE);

    static::assertInstanceOf(InstallerInterface::class, $installer);
  }
